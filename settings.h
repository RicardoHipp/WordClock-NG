...
// !!!!Partitionshema unter Werkzeuge auf NO OTA 2MB/2MBSPIFFS" stellen, wir aus der partitions.csv aber die IDE bringt sonst eine Fehler wegen fehlendem Speicher!!!!
// Unter Datei den Pfad für das Sketchbook auf den Code Ordner setzen,. damit die hinterlgen Bibliothken genutze werden, nicht updaten!


// ###########################################################################################################################################
// # Sprache / Language — wird zur Compile-Zeit festgelegt (nur eine Sprache wird eincompiliert)
// #
// # !!! HIER DIE GEWÜNSCHTE SPRACHE EINTRAGEN UND NEU FLASHEN !!!
// #
// #  0  =  Deutsch          (DE)
// #  1  =  Englisch         (EN)
// #  2  =  Niederländisch   (NL)
...
// #  4  =  Italienisch      (IT)
// #  5  =  Französisch      (FR)
// #  6  =  Schweizerdeutsch (GSW)
// #  7  =  Chinesisch       (CN)
// #  8  =  Schwäbisch       (SCHWB)
// #  9  =  Bayrisch         (BAY)
// # 10  =  Luxemburgisch    (LTZ)
// # 11  =  Ostdeutsch       (EAST)
// ###########################################################################################################################################
#define LANGUAGE 9
...
// # Hardware settings:
// ###########################################################################################################################################
#define LEDPIN 1                                                                      // ESP32 pin connected to the NeoPixels matrix
...
//RTC optional nur wichtig für offline Modus, geht auch ohne ist aber genauer und verliert die Zeit bei Stromverlust nicht
#define DS3231_SDA 4                                                                   // I2C SDA pin for optional DS3231 RTC
#define DS3231_SCL 3                                                                   // I2C SCL pin for optional DS3231 RTC
...
int wifiTimeout_default = 0;     // WiFi timeout in minutes (0 = disabled)
int ntpSyncHour_default   = 3;   // Hour of the daily NTP resync (0-23)
int ntpSyncMinute_default = 0;   // Minute of the daily NTP resync (0-59)


// ###########################################################################################################################################
// # Variables declaration in Online Mode:
// ###########################################################################################################################################
#define DEFAULT_AP_NAME "NewWordClock"  // WiFi access point name of the ESP32
...
const char* Offline_SSID = "NewWordClock Offline Mode";  // SSID of the internal WiFi access point used in Offline Mode
const char* Offline_PW = "wordclock";                 // Access point with password protection. Minimum 8 characters needed!
